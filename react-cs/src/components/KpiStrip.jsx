...
export function KpiStrip({ totalBuy, totalMarket, profit, pct, totalPts, activeCount, accentCol, redCol }) {
  return (
    <div className="kpi-strip">
      <div className="kpi-cell">
        <div className="kpi-cell-label">Investi</div>
        <div className="kpi-cell-val">{fmt(totalBuy)} €</div>
        <div className="kpi-cell-sub">{activeCount} skin{activeCount !== 1 ? "s" : ""}</div>
      </div>
      <div className="kpi-cell">
      ...
      <div className="kpi-cell">
        ...
        <div className="kpi-cell-val" style={{ color: profit >= 0 ? accentCol : redCol }}>
          {profit >= 0 ? "+" : ""}{fmt(profit)} €
        </div>
      ...
      <div className="kpi-cell">
        ...
        <div className="kpi-cell-sub">historique Steam + local</div>
      </div>
    </div>
  );
}